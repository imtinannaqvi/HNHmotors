...
const CarCard = ({ car }) => {
  ...
  return (
    <div
      ...
      className="bg-white border border-gray-100 rounded-md overflow-hidden transition-all duration-300 group hover:shadow-xl hover:border-orange-200 hover:-translate-y-1 cursor-pointer">
